...
**32 years later**, I'm still driven by the same curiosity—learning, building, and sharing knowledge.

---

## 💼 What I Do

- **IoT Product Development**: Custom PCBs, ESP32/STM32 firmware, sensor integration, cloud connectivity
- **Platform Architecture**: Kubernetes, microservices, event-driven systems, cloud-native solutions
- **Enterprise Integration**: API strategy, system integration, legacy modernization, CI/CD pipelines
- **Full-Stack Development**: From assembly and C/C++ to Python, Java, and modern web technologies

🌐 **Personal Site**: [dias.net.au](https://dias.net.au)  
...
![ActiveMQ](https://img.shields.io/badge/-ActiveMQ-e3695f?style=flat-square)
...
26M+          │ Data Points Processed (Solar Monitoring System)
99.8%         │ Production Uptime (3+ Years)
30+           │ Enterprise Systems Integrated
```
...
- **ML Pet Recognition**: TensorFlow Lite on ESP32-CAM for edge AI
- **Home Automation**: Garage controller, pet door—both custom PCBs + firmware
...
- **Scale**: 30+ systems integrated, 50+ APIs, 400K+ annual users
...
- 33 professional certifications total
- 🎯 Currently pursuing: Certified Kubernetes Administrator (CKA)
...
- ☸️ Studying for Kubernetes certification
- 🏗️ Platform architecture and cloud-native solutions
- 📚 Sharing knowledge and mentoring developers

---

**"In 1993, I saw a computer and decided to learn. 32 years later, I'm still learning."**
